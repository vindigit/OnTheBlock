...
- Config-driven 4-location / 12-drug market generation with deterministic seeding.
...
- Hidden market conditions affect price and volatility only; drug availability is uniformly sampled so all 12 products appear evenly over time.
